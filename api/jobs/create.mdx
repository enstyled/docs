...
<ParamField body="arrangement" type="string" required default="remote">
...
<ParamField body="term_id" type="integer" required>
...
<ParamField body="application_type" type="string" required default="url">
