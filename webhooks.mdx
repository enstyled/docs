---
title: 'Webhooks'
description: 'JobKit webhooks allows you to integrate your job board with external services, automate tasks and create custom workflows.'
icon: 'webhook'
---
...
The receiving URL should return an appropriate HTTP response code, e.g. `200` for success, `4xx` for client errors and `5xx` for server errors.

Webhook requests will be retried up to 5 times until successfully received.

Please make sure your webhook URL is secure, so you don't leak your users data!
